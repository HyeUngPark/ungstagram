...
class  UserFragment : Fragment(){
    ...
    override fun onCreateView(
        ...
        if(uid === currentUserUid){
            // my page
            fragmentView?.account_btn_follow_siginout?.text = getString(R.string.signout)
            fragmentView?.account_btn_follow_siginout?.setOnClickListener {
                activity?.finish()
            ...
            // other user
            fragmentView?.account_btn_follow_siginout?.text = getString(R.string.follow)
